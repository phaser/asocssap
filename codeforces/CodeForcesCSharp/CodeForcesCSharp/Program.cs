...
public class CF_2B
{
    static int Main(string[] args)
    {
        ...
        //    for (int j = 0; j < n; j++)
        //    {
        //        sb.Append((int)(rnd.NextDouble() * 99999999) * 10);
        //        sb.Append(j == n - 1 ? "\n": " ");
        //    }
        //}
        //System.IO.File.WriteAllText("input_gen.txt", sb.ToString());
        //return 0;

        string[] nums;
        Console.SetIn(new System.IO.StreamReader(new System.IO.FileStream("d:/projects/asocssap/codeforces/CodeForcesCSharp/CodeForcesCSharp/input.txt", System.IO.FileMode.Open)));
